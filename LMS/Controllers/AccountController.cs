        ...
        public string CreateNewUser(string fName, string lName, DateTime DOB, string SubjectAbbrev, string role)
        {
            ...
            while (true)
            {
                ...
                var query1 =
                    ...
                    select s;
                var query2 =
                    from s in db.Administrator
                    where s.UId == number.ToString()
                    select s;
                var query3 =
                    from s in db.Professor
                    where s.UId == number.ToString()
                    select s;
            ...
            // Add 0 zeros in front of the random numeber so that it is 7-digit.
            string uid = number.ToString("D7");
            ...
            else if (role == "Professor")
            {
                ...
                p.LastName = lName;
                p.DoB = DOB;
                p.DepartmentAbbr = SubjectAbbrev;
                db.Professor.Add(p);
            }
            else
            {
                ...
                s.LastName = lName;
                s.DoB = DOB;
                s.DepartmentAbbr = SubjectAbbrev;
                db.Student.Add(s);
            }
